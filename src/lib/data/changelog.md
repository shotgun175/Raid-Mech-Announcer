...
- The Raid Editor now shows multi-phase gates (Final Act: Kazeros Gate 2) one phase at a time via a Phase selector, so each phase reads as a clean HP descent instead of the two phases' mechanics interleaving by HP value
