...
{#if next && sev}
  <div style="
    ...
    user-select: none;
  ">
    <div style="width: 7px; height: 7px; border-radius: 50%; background: {sev.color}; box-shadow: 0 0 8px {sev.color}; {urgent ? 'animation: mech-pulse 1.2s infinite;' : ''} flex-shrink: 0;" />
